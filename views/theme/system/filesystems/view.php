            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="spinner-body m-5 p-5 text-center d-none">
                        ...
                        <div id="result" class="">
                            ...
                            <nav class="breadcrumb">
                                <a class="breadcrumb-item filepath"
                                    href="<?= $router->route('fylesystem.pathBack', ['pathBack' => $root]) ?>"><i
                                ...
                                <tbody id="filetbody">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="filename">
                                                <a name="" id="" class="btn btn-outline-gray filepath"
