...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex p-10 no-block">
                            <div class="align-self-center display-6 m-r-20"><i
                                    class="text-success icon-Target-Market"></i></div>
                            <div class="align-slef-center">
                                <h2 class="m-b-0">2346 <small><i class="ti-angle-down text-danger"></i></small>
                                </h2>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex p-10 no-block">
                            <div class="align-self-center display-6 m-r-20"><i class="text-info icon-Dollar-Sign"></i>
                            </div>
                            <div class="align-slef-center">
                                <h2 class="m-b-0">$8,759 <small><i class="ti-angle-up text-success"></i></small>
                                </h2>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex p-10 no-block">
                            ...
                            <div class="align-slef-center">
                                <h2 class="m-b-0">2,356 <small><i class="ti-angle-up text-success"></i></small>
                                </h2>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex p-10 no-block">
                            <div class="align-self-center display-6 m-r-20"><i class="text-danger icon-Contrast"></i>
                            </div>
                            <div class="align-slef-center">
                                <h2 class="m-b-0">38% <small><i class="ti-angle-down text-danger"></i></small>
                                </h2>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table browser m-t-30 no-border">
                            <tbody>
                                <tr>
                                    <td style="width:40px"><img src="<?= asset("images/browser/chrome-logo.png") ?>"
                                            alt="logo">
                                    </td>
                                    <td>Google Chrome</td>
                                ...
                                <tr>
                                    <td><img src="<?= asset("images/browser/firefox-logo.png") ?>" alt="logo">
                                    </td>
                                    <td>Mozila Firefox</td>
                                    <td class="text-right">15%</td>
                                </tr>
                                <tr>
                                    <td><img src="<?= asset("images/browser/safari-logo.png") ?>" alt="logo">
                                    </td>
                                    <td>Apple Safari</td>
                                    <td class="text-right">07%</td>
                                </tr>
                                <tr>
                                    <td><img src="<?= asset("images/browser/internet-logo.png") ?>" alt="logo">
                                    </td>
                                    <td>Internet Explorer</td>
                                    <td class="text-right">09%</td>
                                </tr>
                                <tr>
                                    <td><img src="<?= asset("images/browser/opera-logo.png") ?>" alt="logo">
                                    </td>
                                    <td>Opera mini</td>
                                    <td class="text-right">23%</td>
                                </tr>
                                <tr>
                                    <td><img src="<?= asset("images/browser/edge-logo.png") ?>" alt="logo"></td>
                                    <td>Micorsoft Edge</td>
                                    <td class="text-right">23%</td>
                                </tr>
                                <tr>
                                    <td><img src="<?= asset("images/browser/netscape-logo.png") ?>" alt="logo">
                                    </td>
        ...
        <div class="row">
                        ...
                        <div class="table-responsive m-t-20 no-wrap">
                            <table class="table vm no-th-brd pro-of-month">
                                ...
                                <tbody>
                                    ...
                                    <tr class="active">
                                        <td><span class="round"><img src="<?= asset("images/users/2.jpg") ?>" alt="user"
                                                    width="50"></span></td>
                                        <td>
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="up-img" style="background-image:url(<?= asset("images/big/img1.jpg") ?>"></div>
                    <div class=" card-body">
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            ...
                            <div class="btn-group ml-auto m-t-10">
                                <a href="JavaScript:void(0)" class="sl-icon-options-vertical link"
                    ...
                    <div class="activity-box">
                        <div class="card-body">
                            ...
                            <div class="activity-item">
                                <div class="round m-r-20"><img src="<?= asset("images/users/2.jpg") ?>" alt="user"
                                        width="50"></div>
                                <div class="m-t-10">
                                    <h5 class="m-b-0 font-medium">Mark Freeman <span class="text-muted font-14 m-l-10">|
                                            &nbsp; 6:30 PM</span></h5>
                                    <h6 class="text-muted">uploaded this file </h6>
                                    <table class="table vm b-0 m-b-0">
                                        <tbody>
                                            <tr>
                                                <td class="m-r-10 b-0"><img src="<?= asset("images/icon/zip.png") ?>"
                                                        alt="user">
                                                </td>
                                                <td class="b-0">
                            ...
                            <!-- Activity item-->
                            <div class="activity-item">
                                <div class="round m-r-20"><img src="<?= asset("images/users/3.jpg") ?>" alt="user"
                                        width="50"></div>
                                <div class="m-t-10">
                                    <h5 class="m-b-5 font-medium">Emma Smith <span class="text-muted font-14 m-l-10">|
                                            &nbsp; 6:30 PM</span></h5>
                                    <h6 class="text-muted">joined projectname, and invited <a
                                            href="javascript:void(0)">@maxcage, @maxcage, @maxcage, @maxcage,
                                            @maxcage,+3</a></h6>
                                    <span class="image-list m-t-20">
                                        <a href="javascript:void(0)"><img src="<?= asset("images/users/1.jpg") ?>"
                                                class="img-circle" alt="user" width="50"></a>
                            ...
                            <!-- Activity item-->
                            <div class="activity-item">
                                <div class="round m-r-20"><img src="<?= asset("images/users/4.jpg") ?>" alt="user"
                                        width="50"></div>
                                <div class="m-t-10">
                                    <h5 class="m-b-0 font-medium">David R. Jones <span
                                            class="text-muted font-14 m-l-10">| &nbsp; 9:30 PM, July 13th</span>
                                    </h5>
                                    <h6 class="text-muted">uploaded this file </h6>
                                    <span>
                                        <a href="javascript:void(0)" class="m-r-10"><img
                                                src="<?= asset("images/big/img1.jpg") ?>" alt="user" width="60"></a>
                                        <a href="javascript:void(0)" class="m-r-10"><img
                                                src="<?= asset("images/big/img2.jpg") ?>" alt="user" width="60"></a>
                                    </span>
                                </div>
                            </div>
                            <!-- Activity item-->
                            <!-- Activity item-->
                            <div class="activity-item">
                                <div class="round m-r-20"><img src="<?= asset("images/users/6.jpg") ?>" alt="user"
                                        width="50"></div>
                                <div class="m-t-10">
                                    <h5 class="m-b-5 font-medium">David R. Jones <span
                                            class="text-muted font-14 m-l-10">| &nbsp; 6:30 PM</span></h5>
                                    <h6 class="text-muted">Commented on<a href="javascript:void(0)">Test
                                            Project</a></h6>
                                    <p class="m-b-0">It has survived not only five centuries, but also the leap
                                        into unchanged.</p>
                                </div>
                            </div>
                            <!-- Activity item-->
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label db" for="customCheck">
                                            <span>Lorem Ipsum is simply dummy text of the printing and
                                                typesetting industry. Lorem Ipsum has been</span> <span
                                                class="badge badge-pill badge-danger pull-right">Today</span>
                                        </label>
                                    </div>
                                    <ul class="assignedto">
                                        <li><img src="<?= asset("images/users/1.jpg") ?>" alt="user"
                                                data-toggle="tooltip" data-placement="top" title=""
                                                data-original-title="Steave"></li>
                                        <li><img src="<?= asset("images/users/2.jpg") ?>" alt="user"
                                                data-toggle="tooltip" data-placement="top" title=""
                                                data-original-title="Jessica"></li>
                                        <li><img src="<?= asset("images/users/3.jpg") ?>" alt="user"
                                                data-toggle="tooltip" data-placement="top" title=""
                                                data-original-title="Priyanka"></li>
                                        <li><img src="<?= asset("images/users/4.jpg") ?>" alt="user"
                                                data-toggle="tooltip" data-placement="top" title=""
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label db" for="customCheck1">
                                            <span>Lorem Ipsum is simply dummy text of the printing</span><span
                                                class="badge badge-pill badge-primary pull-right">1 week </span>
                                        </label>
                                    </div>
                                ...
                                <li class="list-group-item" data-role="task">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label db" for="customCheck3">
                                            <span>Lorem Ipsum is simply dummy text of the printing </span> <span
                                                class="badge badge-pill badge-warning pull-right">2 weeks</span>
                                        </label>
                                    </div>
                                    <div class="item-date"> 26 jun 2017</div>
                                </li>
...
<script src="<?= asset("node_modules/c3-master/c3.min.js"); ?>"></script>
<!-- Vector map JavaScript -->
<script src="<?= asset("node_modules/vectormap/jquery-jvectormap-2.0.2.min.js"); ?>"></script>
<script src="<?= asset("node_modules/vectormap/jquery-jvectormap-world-mill-en.js"); ?>"></script>
